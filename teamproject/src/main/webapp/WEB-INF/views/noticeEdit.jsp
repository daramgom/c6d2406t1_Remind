                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">공지사항수정</div>
                                <button type="button" class="btn btn-secondary" onclick="document.getElementById('noticeEditForm').submit();">공지사항 수정</button>
                            </div>
                            ...
                            <div class="card-body">
                                <form id="noticeEditForm" action="${pageContext.request.contextPath}/notice/edit" method="post">
                                    ...
                                    <div class="d-flex justify-content-end mt-3">
                                        ...
                                        <a href="${pageContext.request.contextPath}/notice/list" class="btn btn-black">목록으로</a>
                                    </div>
                                </form>
                            </div>
                        </div>
