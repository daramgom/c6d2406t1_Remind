...
<main>
 <h2>입고 요청</h2>
<form action="/web/rcvRQ" id="ReceivingForm" method="post">
    <div class="form-container">
        <div class="form-group">
            <label for="RCV_MANAGER_ID">입고 담당자</label>
            <input type="text" id="RCV_MANAGER_ID" placeholder="홍길동" required  name="RCV_MANAGER_ID" >
        </div>
        
    <label for="ORD_NUMBER">발주 관리번호</label>
    <input type="text" id="ORD_NUMBER" placeholder="발주관리번호입력" required oninput="fetchOrderData()" name="ORD_NUMBER">
</div>

<script>
    function fetchOrderData() {
        const ordNumber = $('#ORD_NUMBER').val();
        
        // 발주 관리번호가 입력된 경우에만 AJAX 요청
        if (ordNumber) {
            $.ajax({
                url: '/web/rcvRQ', // 데이터 요청할 URL
                method: 'GET',
                dataType: 'json',
                data: { ord_number: ordNumber }, // 필요한 경우 파라미터 추가
                success: function(data) {
               
                    $('#prod_cat_code').val(data.prod_cat_code);
                    $('#ORD_DATE').val(data.ord_date);
        ...
        <div class="form-group">
            ...
            <input type="text" id="PROD_ID" placeholder="제품식별코드를 입력" required name="COMPANY_CODE">
        </div>

        <div class="form-group">
            <label for="prod_cat_code">카테고리</label>
            <input type="text" id="prod_cat_code" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="COMPANY_CODE" required name="">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" id="ORD_DATE" required readonly>
        </div>

        <div class="form-group">
            <label for="RCV_DATE">입고 날짜</label>
            <input type="date" id="RCV_DATE" required>
        </div>

        <div class="form-group">
            <label for="RCV_REMARKS">비고</label>
            <textarea id="RCV_REMARKS" placeholder="전달 할 '내용' ..." required></textarea>
        </div>
