...
<html>
  ...
  <body>
    ...
    <div class="signup-container">
      ...
      >
        ...
        <div class="input-wrapper">
          ...
          <input
            type="email"
            id="email"
            placeholder="itwill@itwillbs.com"
            class="input-field"
            name="member_email"
            required
            value="${member.email}"
        ...
        <div class="input-wrapper">
          <label for="auth-code" class="input-label">인증 코드</label>
          <input
            type="text"
            id="code"
            placeholder="!@#$%^&"
          ...
          <button
            type="button"
            id="verifyCodeBtn"
            class="send-verification-button auth"
            disabled
          >
            코드 인증
          </button>
      ...
      <p class="signup-text">회원이신가요? <a href="/login">로그인</a></p>
    </div>
